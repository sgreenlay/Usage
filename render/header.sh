...
echo "  <script type=\"text/javascript\">"
echo "  //<![CDATA["
echo "  var statusbar_update;addEvent(window, \"load\", function() {if(document.getElementsByName(\"refresh_button\")) {document.getElementsByName(\"refresh_button\")[0].disabled = true;document.getElementsByName(\"refresh_button\")[0].style.background = '#DADADA';document.getElementsByName(\"refresh_button\")[0].style.cursor = \"default\";}statusbar_update = new StatusbarUpdate();statusbar_update.start();});addEvent(window, \"unload\", function() {statusbar_update.stop();});"
echo "  //]]>"
echo "  </script>"
echo " </head>"
echo " <body class=\"gui\">"
